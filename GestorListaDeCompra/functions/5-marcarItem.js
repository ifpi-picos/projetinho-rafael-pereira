...
//         case 1:
//             listaItens.forEach(item => console.log(item.nome))
//             let comprado = prompt('Qual item marcar como comprado?')
//             let verifica = listaItens.find((item) => item.nome === comprado)
//             if(verifica){
//                 let a = listaItens.splice(verifica, 1)
//                 itensComprados.push(a)
//             }
//     }
// }